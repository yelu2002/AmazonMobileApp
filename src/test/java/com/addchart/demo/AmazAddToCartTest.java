	...
	public void doLogin(String userID,String pwd) throws IOException {
		...
		try {
			if(this.loginCheck(driver,userID,pwd))
			{
				...
				//Add item to cart
				driver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(textContains(\"Samsung\"));").click();		
				...
				String expSeller="by Samsung";
				String actSellet=driver.findElementByXPath("//android.view.View[@text='by Samsung']").getText();		
